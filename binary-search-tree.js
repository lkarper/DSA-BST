...
function main() {
    ...
    const letters = 'E A S Y Q U T I O N';
    const lettersArray = letters.split(' ');
    lettersArray.forEach(letter => qBST.insert(letter, letter));
    const h = height(bst);
    console.log(h);
    console.log(isBST(h))
    console.log(isBST(qBST))
    // console.log(thirdLargestNode(bst).value)
    console.log(thirdLargestNode(qBST).value)
    console.log(isBalanced(bst))
    console.log(isBalanced(qBST))
    const balancedBST = new BinarySearchTree();
    balancedBST.insert(3, 3);
    balancedBST.insert(1, 1);
    balancedBST.insert(4, 4);
    balancedBST.insert(6, 6);
    console.log(isBalanced(balancedBST))
    const arr1 = [3, 5, 4, 6, 1, 0, 2];
    const arr2 = [3, 1, 5, 2, 4, 6, 0];
    const arr3 = [3, 2, 5, 1, 4, 6, 0];
    const arr4 = [3, 5, 4, 6, 2, 0, 1];
    const arr5 = [3, 5, 1, 2, 0, 6, 4];
    console.log(sameBST(arr1, arr2));
    console.log(sameBST(arr3, arr4));
    console.log(sameBST(arr1, arr4));
    console.log(sameBST(arr2, arr4));
    console.log(sameBST(arr1, arr5));
    console.log(sameBST(arr2, arr5));
}
